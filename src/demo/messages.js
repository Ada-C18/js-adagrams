export default {
  ...
  roundOver: (winner) =>
    `Round over! The winner of this round is ${winner.player} who got ${winner.word} for ${winner.score} points!`,
  gameOver: (winner) =>
    `Game over! Our winner is.... ${winner.player} with a total score of ${winner.score}!`
};
